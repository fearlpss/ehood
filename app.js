...
function hireModal(){modal(`<div class="hire-panel"><h2>🤝 Hire a guy</h2><p class="muted">Send a request for someone to help with a task.</p><div class="hire-options"><button class="secondary" onclick="hireRequest('General help')">🛠️ General help</button><button class="secondary" onclick="hireRequest('Errand / pickup')">📦 Errand / pickup</button><button class="secondary" onclick="hireRequest('Other')">💬 Other</button></div><div class="actions"><button class="secondary" onclick="closeModal()">Close</button></div></div>`)}
